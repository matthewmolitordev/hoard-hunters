...
@export_file("*.tscn") var crypt_dungeon_scene: String = "res://core/levels/dungeon_room_crypt.tscn"
@export_file("*.tscn") var hub_world_scene: String = "res://core/levels/hub_world.tscn"
